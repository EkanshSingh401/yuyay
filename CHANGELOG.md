...
### Added
- Full stack deployed — Next.js frontend on Vercel, FastAPI on Railway
- Clerk authentication replacing custom JWT
- unofficeofthefuture.org live with custom domain
- Real PyPI publish via GitHub Actions on tag
- README with badges and architecture diagram
- Concurrent multi-provider FIOS comparison endpoint
